...
SECRET_KEY = 'django-insecure-k%kx&lzq3v4hvcarh38)tyrkqdu=(in-4!-dot-qrhnvvz(c#='
...
ROOT_URLCONF = 'adventure_api.urls'
...
WSGI_APPLICATION = 'adventure_api.wsgi.application'
